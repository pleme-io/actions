...
- **Catalog entry**: `substrate.lib.release.patterns.rust.cargo-bump` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction cargo-bump ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.rust.cargo-bump
```
