...
- **Catalog entry**: `substrate.lib.release.patterns.sdlc.issue-create` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction issue-create ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.sdlc.issue-create
```
