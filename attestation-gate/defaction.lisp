...
(defaction
  ...
  ((
    ...
    (
      ...
      :default "true")
    (
      :name "gate-receipt-path"
      :type :string
      :required nil
      :default "attestation-gate-receipt.json"))
  :outputs
  ((:name "passed")
    (:name "decision")
    (:name "reason")
  ...
  :behavior
  (:runtime :tatara-script :run-tlisp "attestation-gate/run.tlisp")
  :semver-compat
  :minor
  :attestation
  :required)
