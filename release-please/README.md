# pleme-io · release-please

> Run google/release-please-action.
...
steps:
  ...
  - uses: pleme-io/actions/release-please@v1
    with:
      release-type: "rust"
...
[`changesets`](../changesets/) · [`release-promote`](../release-promote/) · [`semantic-release`](../semantic-release/) · [`yank-version`](../yank-version/)


## Sources

- **Action source**: [`action.yml`](./action.yml) + [`run.tlisp`](./run.tlisp)
- **Catalog entry**: `substrate.lib.release.patterns.release-mgmt.release-please` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction release-please ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.release-mgmt.release-please
```
