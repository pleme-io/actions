...
- **Catalog entry**: `substrate.lib.release.patterns.meta.action-shell-lint` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction action-shell-lint ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.meta.action-shell-lint
```
