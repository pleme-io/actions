...
> Run goreleaser to publish Go binaries to GH Releases.
...
steps:
  ...
  - uses: pleme-io/actions/goreleaser@v1
    with:
...
[`dotnet-publish`](../dotnet-publish/) · [`go-build`](../go-build/) · [`go-test`](../go-test/) · [`golangci-lint`](../golangci-lint/) · [`gradle-build`](../gradle-build/) · [`hex-publish`](../hex-publish/) · [`maven-build`](../maven-build/) · [`mix-test`](../mix-test/)


## Sources

- **Action source**: [`action.yml`](./action.yml) + [`run.tlisp`](./run.tlisp)
- **Catalog entry**: `substrate.lib.release.patterns.language.goreleaser` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction goreleaser ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.language.goreleaser
```
