...
steps:
  ...
  - uses: pleme-io/actions/hex-publish@v1
    with:
      api-key: <required>
```
...
[`dotnet-publish`](../dotnet-publish/) · [`go-build`](../go-build/) · [`go-test`](../go-test/) · [`golangci-lint`](../golangci-lint/) · [`goreleaser`](../goreleaser/) · [`gradle-build`](../gradle-build/) · [`maven-build`](../maven-build/) · [`mix-test`](../mix-test/)


## Sources

- **Action source**: [`action.yml`](./action.yml) + [`run.tlisp`](./run.tlisp)
- **Catalog entry**: `substrate.lib.release.patterns.language.hex-publish` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction hex-publish ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.language.hex-publish
```
