...
- **Catalog entry**: `substrate.lib.release.patterns.hygiene.gh-team-sync` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction gh-team-sync ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.hygiene.gh-team-sync
```
