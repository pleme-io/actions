...
- **Catalog entry**: `substrate.lib.release.patterns.quality.pa11y-ci` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction pa11y-ci ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.quality.pa11y-ci
```
