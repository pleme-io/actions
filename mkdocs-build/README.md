...
steps:
  ...
  - uses: pleme-io/actions/mkdocs-build@v1
    with:
...
[`api-spec-diff`](../api-spec-diff/) · [`changelog-generate`](../changelog-generate/) · [`docs-publish`](../docs-publish/) · [`docusaurus-build`](../docusaurus-build/) · [`hugo-build`](../hugo-build/) · [`mdbook-build`](../mdbook-build/) · [`toc-update`](../toc-update/) · [`vitepress-build`](../vitepress-build/)


## Sources

- **Action source**: [`action.yml`](./action.yml) + [`run.tlisp`](./run.tlisp)
- **Catalog entry**: `substrate.lib.release.patterns.docs.mkdocs-build` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction mkdocs-build ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.docs.mkdocs-build
```
