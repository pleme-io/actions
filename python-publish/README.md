...
steps:
  ...
  - uses: pleme-io/actions/python-publish@v1
    with:
      dry-run: "false"
```
...
|---|---|---|---|
| `dry-run` | no | `false` | Build dist/ but don't upload |
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.python.python-publish
```
