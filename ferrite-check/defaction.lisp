...
(defaction
  ...
  ((:name "materializable")
    ...
    (:name "reason"))
  :behavior
  (:runtime :tatara-script :run-tlisp "ferrite-check/run.tlisp")
  :semver-compat
  :minor
  :attestation
  :required)
