...
steps:
  ...
  - uses: pleme-io/actions/zola-build@v1
    with:
      workdir: "."
```
...
- **Catalog entry**: `substrate.lib.release.patterns.docs.zola-build` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction zola-build ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.docs.zola-build
```
