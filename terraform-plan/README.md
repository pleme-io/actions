...
- **Catalog entry**: `substrate.lib.release.patterns.iac.terraform-plan` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction terraform-plan ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.iac.terraform-plan
```
