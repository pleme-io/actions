# pleme-io · license-finder

> Scan dependencies for license compatibility via license_finder.
...
steps:
  ...
  - uses: pleme-io/actions/license-finder@v1
    with:
...
|---|---|---|---|
| `permitted-licenses` | no | `MIT,Apache-2.0,BSD-3-Clause` |  |
...
- **Catalog entry**: `substrate.lib.release.patterns.security.license-finder` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction license-finder ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.security.license-finder
```
