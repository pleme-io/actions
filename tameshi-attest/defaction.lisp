...
(defaction
  ...
  ((
    ...
    (
      :name "hit-tier"
      :type (:enum (:options ("miss" "redis" "pg" "object")))
      :required nil
      :default "miss")
    (
      :name "eval-ms"
  ...
  ((:name "attested")
    ...
    (:name "outcome-chain"))
  :behavior
  (:runtime :tatara-script :run-tlisp "tameshi-attest/run.tlisp")
  :semver-compat
  :minor
  :attestation
  :required)
