...
steps:
  ...
  - uses: pleme-io/actions/kics-scan@v1
    with:
      workdir: "."
```
...
- **Catalog entry**: `substrate.lib.release.patterns.security.kics-scan` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction kics-scan ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.security.kics-scan
```
