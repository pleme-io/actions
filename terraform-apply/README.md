# pleme-io · terraform-apply

> Run terraform apply against a previously-generated plan file. Pairs with terraform-plan.
...
steps:
  ...
  - uses: pleme-io/actions/terraform-apply@v1
    with:
      plan-path: "tfplan"
      workdir: "."
...
[`iac-forge`](../iac-forge/) · [`pulumi-up`](../pulumi-up/) · [`terraform-plan`](../terraform-plan/)


## Sources

- **Action source**: [`action.yml`](./action.yml) + [`run.tlisp`](./run.tlisp)
- **Catalog entry**: `substrate.lib.release.patterns.iac.terraform-apply` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction terraform-apply ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.iac.terraform-apply
```
