...
steps:
  ...
  - uses: pleme-io/actions/railway-up@v1
    with:
      service: <required>
...
- **Catalog entry**: `substrate.lib.release.patterns.cloud.railway-up` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction railway-up ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.cloud.railway-up
```
