...
- **Catalog entry**: `substrate.lib.release.patterns.mobile.app-store-connect` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction app-store-connect ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.mobile.app-store-connect
```
