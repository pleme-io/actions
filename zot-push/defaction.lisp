...
(defaction
  ...
  ((:name "tag")
    ...
    (:name "reason"))
  :behavior
  (:runtime :tatara-script :run-tlisp "zot-push/run.tlisp")
  :semver-compat
  :minor
  :attestation
  :required)
