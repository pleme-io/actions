...
steps:
  ...
  - uses: pleme-io/actions/go-test@v1
    with:
      packages: "./..."
      race: "true"
```
...
[`dotnet-publish`](../dotnet-publish/) · [`go-build`](../go-build/) · [`golangci-lint`](../golangci-lint/) · [`goreleaser`](../goreleaser/) · [`gradle-build`](../gradle-build/) · [`hex-publish`](../hex-publish/) · [`maven-build`](../maven-build/) · [`mix-test`](../mix-test/)


## Sources

- **Action source**: [`action.yml`](./action.yml) + [`run.tlisp`](./run.tlisp)
- **Catalog entry**: `substrate.lib.release.patterns.language.go-test` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction go-test ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.language.go-test
```
