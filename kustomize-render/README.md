...
- **Catalog entry**: `substrate.lib.release.patterns.k8s.kustomize-render` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction kustomize-render ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.k8s.kustomize-render
```
