...
steps:
  ...
  - uses: pleme-io/actions/maven-build@v1
    with:
      goals: "verify"
      workdir: "."
```
...
[`dotnet-publish`](../dotnet-publish/) · [`go-build`](../go-build/) · [`go-test`](../go-test/) · [`golangci-lint`](../golangci-lint/) · [`goreleaser`](../goreleaser/) · [`gradle-build`](../gradle-build/) · [`hex-publish`](../hex-publish/) · [`mix-test`](../mix-test/)


## Sources

- **Action source**: [`action.yml`](./action.yml) + [`run.tlisp`](./run.tlisp)
- **Catalog entry**: `substrate.lib.release.patterns.language.maven-build` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction maven-build ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.language.maven-build
```
