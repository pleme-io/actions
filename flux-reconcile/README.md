...
- **Catalog entry**: `substrate.lib.release.patterns.k8s.flux-reconcile` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction flux-reconcile ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.k8s.flux-reconcile
```
