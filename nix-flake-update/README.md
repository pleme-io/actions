...
- **Catalog entry**: `substrate.lib.release.patterns.sdlc.nix-flake-update` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction nix-flake-update ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.sdlc.nix-flake-update
```
