...
- **Catalog entry**: `substrate.lib.release.patterns.uncategorized.k6-load-test` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction k6-load-test ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.uncategorized.k6-load-test
```
