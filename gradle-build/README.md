# pleme-io · gradle-build

> Build a Gradle project (Java/Kotlin/Scala).
...
steps:
  ...
  - uses: pleme-io/actions/gradle-build@v1
    with:
      tasks: "build"
      workdir: "."
```
...
[`dotnet-publish`](../dotnet-publish/) · [`go-build`](../go-build/) · [`go-test`](../go-test/) · [`golangci-lint`](../golangci-lint/) · [`goreleaser`](../goreleaser/) · [`hex-publish`](../hex-publish/) · [`maven-build`](../maven-build/) · [`mix-test`](../mix-test/)


## Sources

- **Action source**: [`action.yml`](./action.yml) + [`run.tlisp`](./run.tlisp)
- **Catalog entry**: `substrate.lib.release.patterns.language.gradle-build` —
  [patterns-full.nix](https://github.com/pleme-io/substrate/blob/main/lib/release/patterns-full.nix)
- **Future typed source**: `(defaction gradle-build ...)` per
...
```bash
nix eval --raw github:pleme-io/substrate#lib.aarch64-darwin.release.patterns.language.gradle-build
```
