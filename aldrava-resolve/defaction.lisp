...
(defaction
  ...
  ((:name "should-run")
    ...
    (:name "reason"))
  :behavior
  (:runtime :tatara-script :run-tlisp "aldrava-resolve/run.tlisp")
  :semver-compat
  :minor
  :attestation
  :none)
